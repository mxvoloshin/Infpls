...
(function (window, angular, undefined) {
     ...
     *   `/customer/:customername`. If you are using a URL with a port number (e.g.
     ...
     *   ```js
     *   var customer = $resource('/customer/:customerId', {customerId:'@id'});
     ...
     * ```js
         ...
         var CreditCard = $resource('/customer/:customerId/card/:cardId',
          {customerId:123, cardId:'@id'}, {
           charge: {method:'POST', params:{charge:true}}
          });
    
         // We can retrieve a collection from the server
         var cards = CreditCard.query(function() {
           // GET: /customer/123/card
           ...
           card.$save();
           // POST: /customer/123/card/456 {id:456, number:'1234', name:'J. Smith'}
           // server returns: {id:456, number:'1234', name: 'J. Smith'};
    
           // our custom method is mapped as well.
           card.$charge({amount:9.99});
           // POST: /customer/123/card/456?amount=9.99&charge=true {id:456, number:'1234', name:'J. Smith'}
         });
         ...
         newCard.$save();
         // POST: /customer/123/card {number:'0123', name:'Mike Smith'}
     ...
     * operations (create, read, update, delete) on server-side data.
       ...
       ```js
         var customer = $resource('/customer/:customerId', {customerId:'@id'});
         customer.get({customerId:123}, function(customer) {
           customer.abc = true;
           customer.$save();
         });
       ```
     ...
     *
       ```js
         var customer = $resource('/customer/:customerId', {customerId:'@id'});
         customer.get({customerId:123}, function(u, getResponseHeaders){
           u.abc = true;
           u.$save(function(u, putResponseHeaders) {
             //u => saved customer object
